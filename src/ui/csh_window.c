...
static void
csh_window_class_init (CshWindowClass *klass)
{
    printf("Class init\n");
...
static void
csh_window_init(CshWindow * self) {
...
CshWindow *
csh_window_new(GtkApplication * application) {
    printf("Window new\n");
