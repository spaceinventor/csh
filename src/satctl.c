...
PARAM_DEFINE_STATIC_RAM(100, u32, PARAM_TYPE_UINT32, 12, 0, UINT32_MAX, PARAM_READONLY_FALSE, NULL, "", &u32_data, NULL);
...
PARAM_DEFINE_STATIC_RAM(103, flt, PARAM_TYPE_FLOAT, 12, -1, -1, PARAM_READONLY_FALSE, NULL, "", &flt_data, NULL);
