...
const struct slash_command slash_cmd_node;
static int cmd_node(struct slash *slash) {
    optparse_t * parser = optparse_new_ex(slash_cmd_node.name, slash_cmd_node.args, slash_cmd_node.help);
...
static int cmd_node_list(struct slash *slash) {
    ...
    optparse_t * parser = optparse_new_ex(slash_cmd_node_list.name, slash_cmd_node_list.args, slash_cmd_node_list.help);
    optparse_add_help(parser);
    optparse_add_string(parser, 'f', "filename", "PATH", &filename, "write to file");
