...
#define PARAMID_CRYPTO_REMOTE_KEY           152
#define PARAMID_CRYPTO_REMOTE_COUNTER       153
#define PARAMID_CRYPTO_REMOTE_PRIVILEGE     154
#define PARAMID_CRYPTO_REMOTE_ACTIVE        155
